...
-- Upgrade the legacy two-column list into a workflow-aware, typed, versioned
-- reference-dataset contract. Existing LIST_NAME / VALUE readers and rows
-- remain valid; typed datasets populate the additional lineage columns.
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS WORKFLOW_ID VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS DATASET_NAME VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS DATASET_VERSION_ID VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS VALUE_TYPE VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS VALUE_JSON VARIANT;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS KEY_JSON VARIANT;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS SOURCE_KIND VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS SOURCE_NAME VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS SOURCE_SHA256 VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS STATUS VARCHAR;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS EFFECTIVE_FROM TIMESTAMP_TZ;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
    ADD COLUMN IF NOT EXISTS EFFECTIVE_TO TIMESTAMP_TZ;
ALTER TABLE FOODBUY_MASALA_PROD.COMPLIANCE_LAB.COMPLIANCE_RULES_REFERENCE_LISTS
...
-- --------------------------------------------------------------------------
-- 10. Persistent evidence rows not covered by governed semantic policy
-- --------------------------------------------------------------------------
